...
class DatabaseService {
  final CollectionReference userdetailCollection = Firestore.instance.collection('userspecifics');
  final String uid;
  static String ud = '';
  DatabaseService({this.uid});

  Future updateUserData({String name, String age, String height, String weight,String gender,String activelevel,String caloriesdone, String protein,String fat,String carbs}) async {
...
//   }
  ...
  Stream<Datamod> get userspecfics{
    return userdetailCollection.document(uid).snapshots().map(userDataFromSnapshot);
}
}